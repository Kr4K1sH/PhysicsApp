...
public class beanRegistroPersona implements Serializable {
 ...
 public String insertarPersona() throws SNMPExceptions, SQLException, NamingException, ClassNotFoundException {
        ...
        try{
          if (validar() == false) {
             ...
             f1.setID_Distrito(this.ID_Distrito);
              ...
              if (fDB.validarRepetido(this.IdPersona)) {
             FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, "Duplicidad -", "Codigo de Programa ya esta Registrado."));
             this.Limpiar();
             this.setMensaje("Usuario ya se encuentra registrado!");
 ...
 public String insertarPersonaAdmin() throws SNMPExceptions, SQLException, NamingException, ClassNotFoundException {
        personaDB fDB = new personaDB();    persona f1 = new persona();
        try{
          if (validar() == false) {
   ...
   if (this.Contrasenna.equalsIgnoreCase(this.Contrasenna2)){
   return true;
   }else{
       this.setMensaje("Las contrasenas no son iguales");
   return false;
   }
       ...
       this.setContrasenna("");
       this.setContrasenna2("");
       this.setCorreo("");
       this.setEdad(0);
       Date dt = null;
       this.setFechaNacimiento(dt);
       this.setID_Canton(0);
